...
public class InputCodeJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnXacNhan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/Right.png"))); // NOI18N
        ...
        btnReSend.setBackground(new java.awt.Color(102, 204, 255));
        btnReSend.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnReSend.setForeground(new java.awt.Color(0, 0, 51));
        btnReSend.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/Gear.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputCodeJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void isSuccess() {
        ...
        if (txtCode.getText().trim().equals(nhanVien.getVerifyQMK())) {
