...
public class NguoiHocDAO extends EduVNDAO<NguoiHoc, String> {
    ...
    public void insert(NguoiHoc model) {
        String sql = "INSERT INTO NguoiHoc (MaNH, HoTen, NgaySinh, GioiTinh, DienThoai, Email, Hinh, GhiChu, MaNV) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        XJdbc.update(sql,
                model.getMaNH(),
                model.getHoTen(),
                model.getNgaySinh(),
    ...
    public void update(NguoiHoc model) {
        String sql = "UPDATE NguoiHoc SET HoTen=?, NgaySinh=?, GioiTinh=?, DienThoai=?, Email=?, Hinh=?, GhiChu=?, MaNV=? WHERE MaNH=?";
        XJdbc.update(sql,
                model.getHoTen(),
                model.getNgaySinh(),
                model.getGioiTinh(),
