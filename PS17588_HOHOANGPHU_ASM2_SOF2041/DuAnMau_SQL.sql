...
(N'phuho', N'123456', N'Hồ Hoàng Phú', 1),
(N'ngocky', N'123456', N'Hồ Ngọc Kỳ', 1),
(N'wibu', N'123456', N'wibumecode', 0),
(N'ThaoLTH', N'songlong', N'Lê Thị Hương Thảo', 0)
GO

	--table nguoi hoc
INSERT INTO NguoiHoc VALUES
(N'PS17588', N'Hồ Hoàng Phú', CAST('09-16-2002' AS Date), 1, N'0357337812', N'phuvncom007@gmail.com', N'Nghèo', N'phuho', getDate()),
(N'PS17599', N'Hồ Ngọc Kỳ', CAST('10-16-2000' AS Date), 0, N'0988818789', N'ngocky@gmail.com', N'', N'phuho', getDate()),
(N'PS01638', N'LỮ HUY CƯỜNG', CAST(0xAF170B00 AS Date), 1, N'0928768265', N'PS01638@fpt.edu.vn', N'0928768265 - LỮ HUY CƯỜNG', N'TeoNV', CAST(0xAF170B00 AS Date)),
