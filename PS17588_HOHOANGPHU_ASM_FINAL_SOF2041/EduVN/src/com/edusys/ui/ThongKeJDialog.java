...
public class ThongKeJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblBangDiem.setBackground(new java.awt.Color(255, 255, 153));
        ...
        tblDiemChuyenDe.setBackground(new java.awt.Color(255, 255, 153));
        ...
        tblDoanhThu.setBackground(new java.awt.Color(255, 255, 153));
    ...
    public void init() {
        ...
        JTableHeader header1 = tblBangDiem.getTableHeader();
        header1.setFont(new Font("segoe", Font.BOLD, 15));
        header1.setForeground(new Color(51, 51, 51));
        JTableHeader header2 = tblDiemChuyenDe.getTableHeader();
        header2.setFont(new Font("segoe", Font.BOLD, 15));
        header2.setForeground(new Color(51, 51, 51));
        JTableHeader header3 = tblDoanhThu.getTableHeader();
        header3.setFont(new Font("segoe", Font.BOLD, 15));
        header3.setForeground(new Color(51, 51, 51));
